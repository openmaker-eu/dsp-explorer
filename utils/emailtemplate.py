...
<p>thank you for helping to grow the <strong>OpenMaker</strong> community!</p>
...
<p>
If you want to nominate another person, do it <a href="http://openmaker.eu/nominate" target="_blank">here</a>!</p>
'''

invitation_email_receiver = '''
<h1>Hi {RECEIVER_FIRST_NAME} {RECEIVER_LAST_NAME},</h1>
<p>you have been nominated by <strong>{SENDER_FIRST_NAME} {SENDER_LAST_NAME}</strong> as an influencer in the current 4th Industrial Revolution.<p>
 
<p>We are building a community of people eager to drive radical change in our society, making the most of talent, knowledge and capacity to reshape production according to principles of democracy, inclusivity and sustainability.</p>

<p>We believe in innovation centered on people, and in technology as an enabler of empowered creativity and action for individuals.</p>
 
We are confident in the ability of open collaboration to tackle complex societal challenges, and we push for a systemic revolution in manufacturing which is locally focused but globally connected, micro yet massive.</p>  
