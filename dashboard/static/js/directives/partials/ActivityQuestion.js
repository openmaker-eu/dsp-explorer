...
let activities = {
    domain: {
        label:'As a maker/manufacturer/stakeholder/user which of the following maker related activity domains or application areas would you say you are most active?',
    ...
    area: {
        label: 'As a maker/manufacturer/stakeholder/user which of the following technology areas are you most interested in or most familiar with?',
    ...
    technology: {
        label: 'As a maker/manufacturer/stakeholder/user which of the following specific technologies are you most interested in or familiar with? Please select all relevant options',
    ...
    skills: {
        label: 'As a maker/manufacturer/stakeholder/user which of the following skills are you using most? Please select all relevant options',
...
let template = `
    ...
    <h5 class="text-brown italic">Please select the options that better describes you. This will improve your user experience and increase your impact on the  OpenMaker community.</h5>
    <br>
    <div ng-repeat="(key,activity) in activities" class="activities-form" >
        <label for="" class="capitalize">{$ activity.label $}</label>
        <ui-select
